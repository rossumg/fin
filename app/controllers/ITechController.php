...
class ITechController extends Zend_Controller_Action
{
    ...
    public function __construct(Zend_Controller_Request_Abstract $request, Zend_Controller_Response_Abstract $response, array $invokeArgs = array())
    {
        ...
        try {
            ...
            throw new Exception($e . 'Could not connect to a database associated with this country. Please double check that you have the correct URL and that the site is configured correctly.');
        }
